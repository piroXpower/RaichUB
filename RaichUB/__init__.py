...
__author__ = "RaichUB <https://github.com/piroXpower/RaichUB>"
__copyright__ = "RaichUB Copyright (C) 2020 - 2021  " + __author__

raichub.version = __version__
raichub.tgbot.version = __version__
